...
module DALEC_deciduous
  ...
  contains
  subroutine runModel(cNew,simu)
      real(kind=8),dimension(21)::cNew
      real(kind=8),dimension(5844)::simu
      integer:: i
  ! set parameters
  !open(unit=12, file='./paramValue.txt')
  !read(12,*) (cNew(i), i=1,21)
  !close(12)
  gdd_min=cNew(1)
  gdd_max=cNew(2)
  laimax=cNew(3)
